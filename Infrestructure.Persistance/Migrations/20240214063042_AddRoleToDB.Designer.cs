...
namespace Infrestructure.Persistance.Migrations
{
    ...
    [Migration("20240214063042_AddRoleToDB")]
            ...
            modelBuilder.Entity("Core.Domain.Entities.Role.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 2, 14, 10, 0, 42, 290, DateTimeKind.Local).AddTicks(5579),
                            IsDeleted = false,
                            RoleName = "SuperAdmin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 2, 14, 10, 0, 42, 290, DateTimeKind.Local).AddTicks(5593),
                            IsDeleted = false,
                            RoleName = "Admin"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 2, 14, 10, 0, 42, 290, DateTimeKind.Local).AddTicks(5594),
                            IsDeleted = false,
                            RoleName = "User"
                        });
                });
