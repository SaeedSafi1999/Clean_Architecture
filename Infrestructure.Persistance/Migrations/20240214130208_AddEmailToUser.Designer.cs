...
namespace Infrestructure.Persistance.Migrations
{
    ...
    [Migration("20240214130208_AddEmailToUser")]
            ...
            modelBuilder.Entity("Core.Domain.Entities.Role.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 2, 14, 16, 32, 7, 980, DateTimeKind.Local).AddTicks(7098),
                            IsDeleted = false,
                            RoleName = "SuperAdmin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 2, 14, 16, 32, 7, 980, DateTimeKind.Local).AddTicks(7112),
                            IsDeleted = false,
                            RoleName = "Admin"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 2, 14, 16, 32, 7, 980, DateTimeKind.Local).AddTicks(7113),
                            IsDeleted = false,
                            RoleName = "User"
                        });
                });
